...
public class RegUsuario extends JPanel {
	...
	/**
	 * Constructor del panel de registro de usuario que se añadirñ a la ventana que se pasa
	 * como parñmero
	 * @param ab ventana anterior a la que se vuelve si se cancela el registro de usuario
	 * @param padre ventana a la que se añadirñ el panel
	 */
	...
	public class OyenteKey extends KeyAdapter{
		...
		/**
		 * Mñtodo que detecta pulsaciñn de teclado sobre los campos de texto y que añade
		 * el usuario a la base de datos si la ecla pulsada es intro y todos los datos
		 * estñ correctamente introducidos
