...
public class PanelAniadirEjemploBD extends JPanel {
	 ...
	 * el tipo de ejemplo y el texto que lo representa, así como la vista
	 * gráfica para actualizar el arbol de ejemplos
	 * @param parent ventna sobre la que se añadirá el panel
	 * @param v vista gráfica
	 * @param texto representación del ejemplo en texto
