...
public class PanelAniadirEjerBD extends JPanel{
	 ...
	 * el tipo de ejercicio y el texto que lo representa, asñ como la vista
	 * grñfica para actualizar el arbol de ejercicios
	 * @param parent ventna sobre la que se añadirñ el panel
	 * @param v vista grñfica
	 * @param texto representaciñn del ejercicio en texto
