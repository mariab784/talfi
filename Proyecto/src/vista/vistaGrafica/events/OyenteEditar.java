...
/**
 * Clase que implementa los mñtodoa para mover estado y aristas del automata
...
public class OyenteEditar extends MouseAdapter {
	...
	/**
	 * Creaciñn del oyente que recibe el panel de dibujos
	...
	/**
	 * Evento de pulsaciñn de tecla de ratñn, si es la tecla izquierda
	 * y estñ sobre un estado o una arista esta se podrñ mover en el dibujo
	...
	/**
	 * Mñtodo que detecta el evento de soltar la tecla del ratñn, si tenña algñn
	 * estado o arista seleccionado con el ratñn se deselecciona y ya no se puede 
	 * mover hasta pulsarlo de nuevo, se pinta la arista/estado en el puntñ
	 * ñltimo en el que se dejñ
	 * @param e evendo de dejar de pulsar tecla de ratñn
	 */
	...
	/**
	 * Mñtodo que detecta cuando se estñ moviendo el ratñn sobre el panel de dibujo con
	 * en botñn pulsado, si tiene un estadoo varios o una arista seleccionados se van 
	 * moviendo y pintando segñn se mueve, sino no hace nada
