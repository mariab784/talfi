...
/**
 *  Clase que implemta la creación del panel de introducción del alfabeto para
 *  la expresión regular y crea también el alfabeto si todo va bien
...
public class PanelAlfabeto extends JPanel {
	...
	/**
	 * Constructor del panel de la introducción del alfabeto sobre la ventana
	 * que recibe y que posteriormente crea el alfabeto si está correctamente 
	 * introducido
	 * @param dialogo ventana a la que se le añadirá el panel del alfabeto
	 */
	...
	/**
	 * Método accesor del atributo que indica si todo ha ido bien en la
