 ...
 * que además pueda incluir transiciones lambda
...
public class AutomataFNDLambda extends AutomataFND {
	...
	* aristas y transiciones lambda se convertirá en indeterminista lambda
	*/
	 ...
	 * @param estado del que se quiere sacar la información
	 * @param letra que usamos para ver a qué estado llegamos
	 ...
	 * @param estados de los que se quiere sacar la información
	 * @param letra que usamos para ver a qué estados llegamos
	...
	public ArrayList<String> cierreLambda(String estado){
		...
		//Si estado no tiene ningún enlace, o no tiene ninguno lambda, devolvemos estado (siempre podemos ir al mismo estado usando lambda)
