...
/**
 * Clase que se encarga de añadir las aristas al dibujo si la infromaciñn
...
public class OyenteArista extends MouseAdapter {
	...
	/**
	 * Mñtodo que devuelve el componente grñfico que contiene una lista con todos
	 ...
	 * @return menu con los posibles estados de finalizaciñn que contiene todos lo estado
	 */
	...
	/**
	 * Mñtodo que devuelve el nombre del estado origen de la arista
	...
	/**
	 * Mñtodo que establece el nombre del estado origen de la arista
	...
	/**
	 * Mñtodo que devuelve el nombre del estado destino de la arista
	...
	/**
	 * Mñtodo que establece el nombre del estado destino de la arista
	...
	/**
	 * Mñtodo que devuelve el nombre del estado
	...
	/**
	 * Mñtodo modificador del nombre del estado
	...
	/**
	 * Mñtodo que devuelve el nombre de la arista, las letras de la mismo
	...
	/**
	 * Mñtodo modificador del nombre de la arista
	...
	/**
	 * Mñtodo accesor del campo de texto donde se escribe el nombre de la arista, las
	 * letras de la misma
	...
	/**
	 * Mñtodo modificador del campo de texto donde se escribe el nombre de la arista, las
	 * letras de la misma
	...
	/**
	 * Mñtodo accesor del campo de texto donde se escribe el nombre del estado
	...
	/**
	 * Mñtodo modificador del campo de texto donde se escribe el nombre del estado
	...
	/**
	 * Mñtodo que detecta la pulsaciñn sobre el panel, si debajo hay un estado
	 * y se ha pulsado el boton derecho se inicia la creaciñn de la arista
	 * @param e evento de pulsaciñn de tecla del ratñn
	 */
	...
	/**
	 * Mñtodo que detecta que se ha soltado una tecla sobre el panel,
	 * si es la tecla izquierda y habña un estado origen al pulsarla y 
	 * se estñ dibujando una arista el dibujo se completa pidiendo las
	 * letras que llevarñ la arista
	...
	/**
	 * Mñtodoq ue detecta que se estñ arrastrnado el ratñn sobre el panel con uan tecla
	 * pulsada, si es la izquierda y habña un estado debajo al pulsarla se va dibujando
	...
	/**
	 * Mñtodo que detecta que se ha pulsado y soltado una tecla del ratñn sobre el panel
	 * si se ha hecho con el boon detrecho y debajo habña un estado o una arista se 
	 ...
	 * @param a arista de la que se extrae la infromaciñn que se muestra
...
/*	private void meteSimbolosAPTuring(int caso) throws NullPointerException {
	...
	private void actionTransicionPila(){
		...
		try{
			...
			System.out.println("ARISTAS: " + ((AutomataPila) canvas.getAP()).getAutomataPila());
	...
	/**
	 * Crea el diñlogo con la infromaciñn de la arista que recibe como parñmetro
	 * @param a arista de la que se extrae la infromaciñn que se muestra
	 */
	...
	/**
	 * Crea el diñlogo con la infromaciñn del estado que recibe como parñmetro
	 * @param e estado del que se extrae la infromaciñn que se muestra
	 */
