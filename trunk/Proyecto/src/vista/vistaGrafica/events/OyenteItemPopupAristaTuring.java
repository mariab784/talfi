 ...
 * de la arista de la MT que se ha seleccionado con el menu de PopUp
 *  @author Rocío Barrigüete, Mario Huete, Luis San Juan
 *
 */

public class OyenteItemPopupAristaTuring implements ActionListener {
		 ...
		 */
		public OyenteItemPopupAristaTuring(AristaTuring a,OyenteArista m){
			arista=a;
			mouse=m;
		}
		...
		public void actionPerformed(ActionEvent e) {
			...
			mouse.createDialogAristaTuring(arista); 
