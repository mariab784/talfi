 ...
 *  @author Luis San Juan, Rocio Barrigüete, Mario Huete
 *
 */
public class MinimizacionAFD implements Algoritmo{
	...
	/*En esta función voy a añadir un estado trampa explicito al automata que recibamos*/ 
	...
	*/
	private void paso(){   //El metodo paso muestra la tabla por consola y luego marca
		...
		//A partir de aquí vamos a marcar los pares no marcados al inicializar
		...
		do{//Si no son iguales al final de la iteracion, no he acabado
			...
			while (pares.hasNext()){
				...
				while (segundo.hasNext()){
					System.out.println("y también paso por esta mierda de sitio");
					...
					if (tabla.get(primera).get(segunda).getMarcado()){
						...
						System.out.println("aquí vamos a ver que son las putas aristas");
						System.out.println(primera);
						System.out.println(segunda);
						/* tengo que mirar si donde va la primera componente de cada una de las aristas
						 * y después de mirar eso mirar si esos estados están marcados, si están marcados
