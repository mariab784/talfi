...
/**
 * Clase que implementa la interfaz de expresiñn regular e implementa las funcines
 * que las mismas realizan en la aplicaciñn.
...
public class ExpresionRegularImpl implements ExpresionRegular {
	...
	/**
	 * Constructor de expresion regular que inicializa la expresion y calcula el ñrbol
	 * sintñctico de la misma de manera recursiva y con una sola pasada.
	 * @param a alfaberto de la expresiñn
	 * @param exp cadena que representa la expresiñn regular
	 * @throws AutomatasException lanza la excepciñn si la expresiñn estñ mal construida
	 * o tiene un error sintñctico. 
	 */
