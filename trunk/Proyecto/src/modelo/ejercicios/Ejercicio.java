...
/**
 * Interfaz que define las funcions de los ejercicios en la aplicaciñn
...
public interface Ejercicio {
	 ...
	 * @return Resultado obtiene el resultado de la correciñn
	 */
	 ...
	 * @throws AutomatasException lanza la excepciñn si hay algñn error
