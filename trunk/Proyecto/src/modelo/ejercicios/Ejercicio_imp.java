 ...
 * de la aplicación así como a su correción.
...
public class Ejercicio_imp implements Ejercicio{
	...
	/**
	 * Constructor que crea un ejercicio con los parámetros que se le pasan
	 * @param enunciado enunciado del ejrcicio
	 * @param entrada entrada del usuario
	 * @param resultado solución del ejercicio
	...
	public boolean corregir(Object respuesta) throws AutomatasException {
		...
		if (respuesta instanceof String) {//ES UNA EXPRESION REGULAR!!!!
			...
			try {
				...
				//que debería ser un string! para poder compararlos después
			...
			algEquivalencia.ejecutar(false);
			return algEquivalencia.getResultado();//devuelve el resultado de la corrección
		}
		return false;
	}
