...
public class ArbolER_imp implements ArbolER{
	...
	/**
	 * Constructor q e genera el árbol con el nodo raíz y los
	 * hijos vacíos
	 * @param raiz el carácter que tendrá el árbol en la raíz
	 */
